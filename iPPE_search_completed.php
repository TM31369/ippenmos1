...
.style125 {font-family: "Times New Roman", Times, serif; font-size: small; }
...
<div id="contents">
  <div class="body style14">
    <form name="form1" method="post" action="">
      <div align="center">
        <p class="style18">&nbsp;</p>
        <p class="style18">VIEW PERSONAL PROTECTIVE EQUIPMENT </p>
      </div>
...
="5px" cellspacing="1" style=" border:1px solid silver">
        <tr>
          <td width="198">&nbsp;</td>
          <td width="519"><p class="style125"><span class="style16"><strong>IC Number </strong>
                    <input type="text" name="search" size="30" />
              </span> <span class="style126">
              <input name="submit" type="submit" class="style3" value="Search" />
          </span></p></td>
          <td width="97">&nbsp;</td>
        </tr>
        <tr bgcolor="#666666" style="color:#FFFFFF">
          <td><div align="center" class="style17"><strong>IC Number </strong></div></td>
          <td><div align="center" class="style17"><strong>Employee Name </strong></div></td>
          <td><div align="center" class="style17"><strong>View</strong><strong>
              <? 
$search=$_POST["search"]; 
$flag=0; 
...
<td><a href='iPPE_completed.php?id=",$row[0],"'><center><img src='procura.png'></center></a>"; 
                         } 
                         if($flag==0) 

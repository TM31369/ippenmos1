...
$mysql_query="UPDATE ippe SET id='$id' , training1='$training1' , training2='$training2' , training3='$training3' , training4='$training4' , training5='$training5' , training6='$training6' WHERE id='$id'";

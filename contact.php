...
<div id="contents">
  <div class="body style14">
    ...
    <table width="470" align="center">
      <tr>
        <td width="183"><img src="contact_png.PNG" width="183" height="166"></td>
        <td width="16">&nbsp;</td>
        <td width="255"><p class="style119">Che Azlisyam  Che Sulaiman<br />
          OSH &amp; Risk Management<br />
          Central Function<br />
          Tel : 013-4305642<br />
          Office : 0322406701</p>
        <p class="style119">Email : azlisyam@tm.com.my</p></td>
      </tr>
    </table>
    <p align="center" class="style21">&nbsp;</p>
    <p align="center" class="style21"><a href="save_excel.php"></a></p>
    <p align="center" class="style21">&nbsp;</p>
  </div>
</div> 
<!-- /#contents -->
